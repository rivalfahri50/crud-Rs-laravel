...
<div class="container mt-5">
    <br>
    <h2 class="text-center">Data Satpam</h2>
    &nbsp; &nbsp;<a href="{{ route('satpam.create') }}" class="btn btn-warning">Add Data</a>
    <div class="row" style="justify-content:end; float: right;">
        <form action="/satpam" method="GET">
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td>
          ...
          <form id="delete-form-{{ $satpam->id }}" action="{{route('satpam.destroy', $satpam->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <a href="{{ route('satpam.edit',$satpam->id) }}" class="btn btn-primary">Edit</a>
            <button type="submit" class="btn btn-danger" onclick="showAlert(event, {{ $satpam->id }})">Delete</button>
        </form>
    </center>
    ...
    <script>
        function showAlert(event, id) {
            ...
            swal({
                ...
                text: "Data satpam akan dihapus secara permanen!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    swal("Data satpam tidak dihapus.");
                }
