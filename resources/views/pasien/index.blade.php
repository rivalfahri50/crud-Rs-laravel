        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item mx-0 mx-lg-1 "><a class="nav-link py-3 px-0 px-lg-3 rounded" href="dashboard">Home</a></li>
    ...
    <tr>
        ...
        <td>
            <form id="delete-form-{{ $pasien->id }}" action="{{route('pasien.destroy', $pasien->id) }}" method="POST">
              ...
              <button type="submit" class="btn btn-danger" onclick="showAlert(event, {{ $pasien->id }})">Delete</button>
            </form>
        </center>
        ...
        <script>
            function showAlert(event, id) {
                ...
                .then((willDelete) => {
                    ...
                    swal("Data pasien tidak dihapus.");
                }
            });
        }
        </script>
