...
<form action="{{ route('jadwal_dokter.store') }}" method="post">
   ...
   <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ date('d-m-Y') }} " placeholder="Masukan Tanggal masuk Anda"  >
    ...
    <a class="btn btn-md btn-danger"href="{{ route('jadwal_dokter.index') }}">KEMBALI</a>
