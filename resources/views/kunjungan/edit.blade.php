...
<form action="{{ route('kunjungan.update', $kunjungan->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('nama_pengunjung') is-invalid @enderror" name="nama_pengunjung" value="{{ old('nama_pengunjung', $kunjungan->nama_pengunjung) }}"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nama_pasien') is-invalid @enderror" name="nama_pasien" value="{{ old('nama_pasien', $kunjungan->nama_pasien) }}"
            ...
            <div class="mb-3">
                ...
                <input type="date" name="tanggal" class="form-control"
                    value="{{ date('Y-m-d', strtotime($kunjungan->tanggal)) }}">
                @error('tanggal')
                    <div class="alert alert-danger mt-2">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('ruang') is-invalid @enderror" name="ruang" value="{{ old('ruang', $kunjungan->ruang) }}"
    ...
    <a href="{{ route('kunjungan.index') }}" class="btn btn-md btn-warning">KEMBALI</a>
    </form>
    </div>
    </div>
    </div>
